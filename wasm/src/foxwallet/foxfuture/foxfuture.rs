...
#[wasm_bindgen]
#[derive(Clone)]
pub struct FoxFuture(FutureNative);
...
impl FoxFuture {
    ...
    pub fn from_string(future: &str) -> Result<FoxFuture, String> {
...
mod tests {
    ...
    fn test_parse_future() {
        ...
        let record = FoxFuture::from_string(&future_text).unwrap();
